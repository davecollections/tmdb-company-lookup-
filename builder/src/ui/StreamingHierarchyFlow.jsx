...
function ProviderSelectionStep({
	...
	return (
		<section className="streaming-hierarchy-select" aria-labelledby="streaming-hierarchy-services-title">
			<div className="add-source-section-heading"><div><p className="panel-kicker">Step 1 · Select</p><h3 id="streaming-hierarchy-services-title" ref={headingRef} tabIndex={-1}>Choose Streaming services</h3></div></div>
